...
traingpuid = int(os.environ.get('DPLSNOWSIMHYDMC_GPU_ID', '0'))
if torch.cuda.is_available():
    torch.cuda.set_device(traingpuid)

EPOCH = int(os.environ.get('DPLSNOWSIMHYDMC_EPOCHS', '10'))
...
saveEPOCH = int(os.environ.get('DPLSNOWSIMHYDMC_SAVE_EPOCH', '1'))
max_iter_ep = int(os.environ.get('DPLSNOWSIMHYDMC_MAX_ITER_EP', '0'))
NMUL = int(os.environ.get('DPLSNOWSIMHYDMC_NMUL', '4'))
ROUTING = os.environ.get('DPLSNOWSIMHYDMC_ROUTING', '1') == '1'
COMPROUT = os.environ.get('DPLSNOWSIMHYDMC_COMPROUT', '0') == '1'
COMPWTS = os.environ.get('DPLSNOWSIMHYDMC_COMPWTS', '1') == '1'
LGDYN = os.environ.get('DPLSNOWSIMHYDMC_LGDYN', '1') == '1'
LGDYNWEIGHT = float(os.environ.get('DPLSNOWSIMHYDMC_LGDYN_WEIGHT', '0.5'))
...
model = rnn.MultiInv_SnowSIMHYDMulTDModel(
    ninv=Ninv,
    nfea=12,
    nmul=NMUL,
