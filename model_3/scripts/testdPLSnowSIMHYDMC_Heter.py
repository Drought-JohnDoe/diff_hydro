...
testgpuid = int(os.environ.get('DPLSNOWSIMHYDMC_HETER_GPU_ID', '0'))
if torch.cuda.is_available():
...
testbatch = int(os.environ.get('DPLSNOWSIMHYDMC_HETER_TEST_BATCH', '64'))
testepoch = int(os.environ.get('DPLSNOWSIMHYDMC_HETER_TEST_EPOCH', '5'))
test_out_suffix = os.environ.get('DPLSNOWSIMHYDMC_HETER_TEST_OUT_SUFFIX', '_HeterQuickE5I20')
...
print('Snow-SIMHYD MC Heter testing finished! Evaluation results saved in\n', outpath)
