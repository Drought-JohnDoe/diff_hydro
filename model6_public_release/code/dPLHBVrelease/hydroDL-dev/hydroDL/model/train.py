...
def testModel(model, x, c, *, batchSize=None, filePathLst=None, doMC=False, outModel=None, savePath=None):
    ...
    for i in range(0, len(iS)):
        ...
        xTemp = x[iS[i]:iE[i], :, :]
        if c is not None and type(model) not in [rnn.MultiInv_HBVModel, rnn.MultiInv_HBVTDModel,
                                                 rnn.MultiInv_SIMHYDModel, rnn.MultiInv_SnowSIMHYDModel,
                                                 rnn.MultiInv_SnowSIMHYDMulTDModel,
                                                 rnn.MultiInv_SnowSIMHYDMulTDHeterModel,
                                                 rnn.MultiInv_DynamicSimHydModel,
        ...
        if type(model) in [rnn.LstmCloseModel, rnn.AnnCloseModel, rnn.CNN1dLSTMmodel, rnn.CNN1dLSTMInmodel,
                           ...
                           rnn.MultiInv_SnowSIMHYDMulTDHeterModel, rnn.MultiInv_DynamicSimHydModel,
                           rnn.MultiInv_DynamicSimHydModelFive, rnn.MultiInv_DynamicSimHydModelSix,
                           rnn.MultiInv_DynamicSimHydModelSeven, rnn.MultiInv_DynamicSimHydModelSixRoutingOnly]:
