...
def parse_args():
    parser = argparse.ArgumentParser(description='Test Model Five')
    ...
    parser.add_argument('--test-out-suffix', type=str, default='_ModelFive')
...
def main():
    ...
    print('Model Five testing finished! Evaluation results saved in\n', outpath)
