...
from hydro_ml.diagnosis import calc_fhv, calc_flv, calc_kge, calc_nse, calc_r2, highflow_nse, lowflow_nse  # noqa: E402
...
def main():
    ...
    out_root = REPO_ROOT / "model6" / "results" / "train_runs" / "model6_physical_fix"
    ensure_dir(out_root)
    ...
    original_wb = pd.read_csv(DATA_ROOT / "outputs" / "Model6_Epoch30_PhysicalAudit" / "model6_epoch30_per_basin_water_balance.csv")
    baseline_diag_npz = DATA_ROOT / "outputs" / "rnnStreamflow" / "CAMELSMODELSIX" / "DynamicSimHydModelSix" / "AllBasins" / FORCING / str(SEED) / "analysis_ep30" / "model_six_diagnostics_ep30.npz"
